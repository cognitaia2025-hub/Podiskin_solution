...
class PagosService:
    ...
    def create(self, pago_data: PagoCreate, usuario_id: int, ip_address: Optional[str] = None) -> dict:
        """
        Crea un nuevo pago.
    ...
    def update(self, pago_id: int, pago_data: PagoUpdate, usuario_id: int, ip_address: Optional[str] = None) -> dict:
        """
