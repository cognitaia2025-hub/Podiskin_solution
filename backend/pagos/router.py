...
async def listar_pagos(
    ...
    factura_solicitada: Optional[bool] = Query(None, description="Filtrar por factura solicitada"),
    factura_emitida: Optional[bool] = Query(None, description="Filtrar por factura emitida"),
